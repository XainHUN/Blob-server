...
function GameServer() {
    ...
    this.config = {
        ...
        playerMinSplitSize: 60,     // Minimum player cell size allowed to split (mass = 60*1000/100 = 10000) 
        ...
        minionStartSize: 150,        // Start size of minions (mass = 32*32/100 = 10.24)
        minionMaxStartSize: 150,     // Maximum value of random start size for minions (set value higher than minionStartSize to enable)
        disableERT: 1,              // Whether or not to disable STOP, MT, and MS controls for minions on clients that support it. (Set to 3 to enable)
        serverMinions: 1,           // Amount of minions each player gets once they spawn
        defaultName: "<r>DeezNutsBot",      // Default name for all minions if name is not specified using command
